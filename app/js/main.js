...
},{"./ajaxSetup":1,"./router":3,"jquery":8}],3:[function(require,module,exports){
'use strict';
...
var _turtleCollection = require('./turtleCollection');

var _turtleCollection2 = _interopRequireDefault(_turtleCollection);
...
var Router = Backbone.Router.extend({
  ...
  routes: {
    "": "home",
    "turtle": "showTurtles",
    "t/:id": "showSpecificTurtle"
  },

  initialize: function initialize(appElement) {
    this.$el = appElement;

    this.ninjas = new _turtleCollection2['default']();
  ...
  home: function home() {
    ...
    this.$el.html(_viewsHomeView2['default']);
  },

  showTurtles: function showTurtles() {
    console.log('show me turtles');
  }

});

},{"./turtleCollection":4,"./views/homeView":6,"jquery":8,"underscore":9}],4:[function(require,module,exports){
'use strict';
...
var _turtle_model = require('./turtle_model');

var _turtle_model2 = _interopRequireDefault(_turtle_model);

var TurtleCollection = _backbone2['default'].Collection.extend({

  url: 'https://api.parse.com/1/classes/ninjas',

  model: _turtle_model2['default'],
...
exports['default'] = TurtleCollection;
module.exports = exports['default'];

},{"./turtle_model":5,"backbone":7}],5:[function(require,module,exports){
'use strict';
...
var TurtleModel = _backbone2['default'].Model.extend({
...
function proccessData(data) {
  return data.map(function (item) {
    return '\n      <li class=\'turtle-list-item\' data-turtle-id="' + item.objectId + '">' + item.FirstName + '</li>\n    ';
  }).join('');
}
